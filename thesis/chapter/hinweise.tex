...
%hier wird auch gleich auf ein Bild referenziert. Die Tilde ~ verhindert, da� das Wort 
...
\begin{table}[ht]
	%zentrieren
	\centering
%konkrete Tabelle, | eine vertikallinie, l Text linksb�ndig, r Text rechtsb�ndig, c zentriert
%jeder der 3 Buchstaben impliziert eine Spalte also cclrl w�rde 5 Spalten erzeugen
...
% & springt in die n�chste Zelle einer Zeile
% \\ Zeilenende/Umbruch
